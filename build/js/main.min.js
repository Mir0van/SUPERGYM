...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    (0, _coachesSlider.initCoachesSwiper)();
    (0, _reviewsSlider.initReviewsSwiper)();
  });
});
...
},{"./modules/coaches-slider":2,"./modules/form-validate/form":4,"./modules/modals/init-modals":10,"./modules/reviews-slider":12,"./modules/tabs/init-tabs":13,"./modules/video":15,"./utils/ios-vh-fix":18}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initCoachesSwiper = void 0;
...
var videoParent = document.querySelector('[data-video-parent]');
...
var initVideo = function initVideo() {
  if (videoParent) {
    var playButton = videoParent.querySelector('[data-play-button]');
    playButton.addEventListener('click', function () {
      var newVideo = createVideo();
